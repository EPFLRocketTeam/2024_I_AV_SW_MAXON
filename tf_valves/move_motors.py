...
def filter():
    ...
    return VALVE_1_PIN_VALUE_FULL, VALVE_1_PIN_VALUE_INTERMEDIATE, VALVE_1_PIN_VALUE_HOME, VALVE_2_PIN_VALUE_FULL, VALVE_2_PIN_VALUE_INTERMEDIATE, VALVE_2_PIN_VALUE_HOME

while True:

    TIME_SLEEP = 0.05
    VALVE_1_PIN_VALUE_FULL, VALVE_1_PIN_VALUE_INTERMEDIATE, VALVE_1_PIN_VALUE_HOME, VALVE_2_PIN_VALUE_FULL, VALVE_2_PIN_VALUE_INTERMEDIATE, VALVE_2_PIN_VALUE_HOME = filter()
