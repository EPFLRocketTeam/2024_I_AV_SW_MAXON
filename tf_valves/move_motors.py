...
VALVE_1_INCREMENT_FULL = int(VALVE_1_FULL/360 * VALVE_INCREMENT_per_turn)
VALVE_2_INCREMENT_FULL = int(VALVE_2_FULL/360 * VALVE_INCREMENT_per_turn)
VALVE_1_INCREMENT_INTERMEDIATE = int(VALVE_1_INTERMEDIATE/360 * VALVE_INCREMENT_per_turn)
VALVE_2_INCREMENT_INTERMEDIATE = int(VALVE_2_INTERMEDIATE/360 * VALVE_INCREMENT_per_turn)
...
def filter():
    global VALVE_1_PIN_FILTER_VALUE_FULL, VALVE_1_PIN_FILTER_VALUE_INTERMEDIATE, VALVE_1_PIN_FILTER_VALUE_HOME, VALVE_2_PIN_FILTER_VALUE_FULL, VALVE_2_PIN_FILTER_VALUE_INTERMEDIATE, VALVE_2_PIN_FILTER_VALUE_HOME
    global VALVE_1_PIN_VALUE_FULL, VALVE_1_PIN_VALUE_INTERMEDIATE, VALVE_1_PIN_VALUE_HOME, VALVE_2_PIN_VALUE_FULL, VALVE_2_PIN_VALUE_INTERMEDIATE, VALVE_2_PIN_VALUE_HOME
    ...
    VALVE_1_PIN_FILTER_VALUE_FULL = min(1, max(0, VALVE_1_PIN_FILTER_VALUE_FULL))
    VALVE_1_PIN_FILTER_VALUE_INTERMEDIATE = min(1, max(0, VALVE_1_PIN_FILTER_VALUE_INTERMEDIATE))
    VALVE_1_PIN_FILTER_VALUE_HOME = min(1, max(0, VALVE_1_PIN_FILTER_VALUE_HOME))
    VALVE_2_PIN_FILTER_VALUE_FULL = min(1, max(0, VALVE_2_PIN_FILTER_VALUE_FULL))
    VALVE_2_PIN_FILTER_VALUE_INTERMEDIATE = min(1, max(0, VALVE_2_PIN_FILTER_VALUE_INTERMEDIATE))
    VALVE_2_PIN_FILTER_VALUE_HOME = min(1, max(0, VALVE_2_PIN_FILTER_VALUE_HOME))
...
while True:
    ...
    while True:
        filter()
        print(f'Pins: {VALVE_1_PIN_FILTER_VALUE_FULL}, {VALVE_1_PIN_FILTER_VALUE_INTERMEDIATE}, {VALVE_1_PIN_FILTER_VALUE_HOME}, {VALVE_2_PIN_FILTER_VALUE_FULL}, {VALVE_2_PIN_FILTER_VALUE_INTERMEDIATE}, {VALVE_2_PIN_FILTER_VALUE_HOME}')
